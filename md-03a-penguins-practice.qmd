...
3.  How many variables are in the data set? Ans= 8 variables
4.  How many observations are in the data set? Ans= 344 observations
...
Starting with `penguins`, group the data by species, then create a summary table containing the maximum and minimum length of flippers (call the columns flip_max and flip_min). How will you handle NA values? Ans= apply the function na.rm =TRUE
